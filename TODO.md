...
[ ] Konfigurations-System: ConfigManager implementieren:
    [ ] TOML-Support
    [ ] Defaults
    [ ] nsd commandline option -d|--debug
      [ ] Setzt XDG-Pfad = Lokaler Pfad ${workspaceFolder}/
      [ ] Default: XDG-Pfad ~/.config/lns/

[ ] IPC-Server: Asyncio-basierter Unix Domain Socket Server (/tmp/nsd.sock).

[ ] Plugin-Loader: Dynamisches Laden von Modulen aus modules/, die von BasePlugin erben.
